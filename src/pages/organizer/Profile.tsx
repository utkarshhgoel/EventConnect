      ...
      <div className="px-4 relative -mt-12">
        <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
          ...
          <div className="mt-4">
            ...
            <p className="text-gray-500 text-sm mt-1 capitalize">{(user?.gender || getParsedSubtitle(user?.subtitle).gender || 'Not specified').toLowerCase()}</p>
          </div>
              ...
              <div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <input 
                    ...
                    className="flex-1 px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none transition-all"
                  />
                </div>
              </div>
