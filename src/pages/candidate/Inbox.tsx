...
export default function Inbox() {
  ...
  // Mock chats
  const chats = [
    { id: 1, name: 'Acme Events', role: 'Organizer', lastMessage: 'Great, see you at 8 AM.', time: '10:30 AM', unread: 1 },
    { id: 2, name: 'Global Tech', role: 'Organizer', lastMessage: 'Your application is under review.', time: 'Yesterday', unread: 0 },
  ];
